...
public class ExpenseServiceTest {
    ...
    void whenGetExpenseById_andExists_thenReturnExpense() {
        ...
        Expense result = service.getExpenseById(expenseId);
    ...
    void testGetAllExpenses() {
        ...
        exp1.setId(2L); // Database usually generates this
        exp1.setDescription("Netflix");
        exp1.setAmount(BigDecimal.valueOf(2.99));
        Expense exp2 = new Expense();
        exp2.setId(1L); // Database usually generates this
        exp2.setDescription("Netflix");
        exp2.setAmount(BigDecimal.valueOf(15.99));

        List<Expense> mockExpenses = Arrays.asList(exp1, exp2);
