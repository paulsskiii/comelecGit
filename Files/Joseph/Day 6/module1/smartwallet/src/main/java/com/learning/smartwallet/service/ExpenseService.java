...
public class ExpenseService {
    ...
    public ExpenseResponseDTO getExpenseById(Long id) {
        ...
        Expense expense = repository.findById(id)
         ...
         ExpenseResponseDTO eres = new ExpenseResponseDTO();
         eres.setDescription(expense.getDescription());
         eres.setAmount(expense.getAmount());
         eres.setCategory(expense.getCategory());
        return eres;
    }
