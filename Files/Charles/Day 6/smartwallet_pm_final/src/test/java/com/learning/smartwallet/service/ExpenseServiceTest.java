...
public class ExpenseServiceTest {
    ...
    void whenGetExpenseById_andExists_thenReturnExpense() {
        ...
        // "When repository.findById(1) is called, return an Optional containing our mockExpense"
    ...
    void whenCreateExpense_thenSaveAndReturn() {
        ...
        // When repo.save is called with ANY Expense object, return the savedExpense we created above
    ...
    @Test
    void whenGetAllExpenses_andExists_thenReturnExpenses() {
        // 1. Arrange (Prepare data)
        List<Expense> mockExpsenses = new ArrayList<>();
        Expense mockExpense1 = new Expense();
        mockExpense1.setId(1L);
        mockExpense1.setDescription("Groceries");
        mockExpense1.setAmount(BigDecimal.valueOf(20.00));
        mockExpsenses.add(mockExpense1);

        Expense mockExpense2 = new Expense();
        mockExpense2.setId(2L);
        mockExpense2.setDescription("Market");
        mockExpense2.setAmount(BigDecimal.valueOf(35.00));

        mockExpsenses.add(mockExpense2);
        
        // STUBBING: Teach the mock how to behave
        when(repository.findAll()).thenReturn(mockExpsenses);
