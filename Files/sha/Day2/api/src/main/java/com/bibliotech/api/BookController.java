...
// CONCEPT: @RestController tells Spring "This class handles web requests and returns JSON data directly."
// It replaces the need to add @ResponseBody to every single method.
@RestController
// CONCEPT: Base Pathing & Versioning.
// All methods in this class will start with /api/v1/books
...
public class BookController {
    ...
    // CONCEPT: @GetMapping handles HTTP GET requests (Safe/Read-only).
    // The URL is simply "/api/v1/books" (Inherited from class).
    // We do NOT use "/get-all-books" because that uses a verb!
    @GetMapping
    ...
    // @RequestBody tells Spring to take the JSON from the request and turn it into
    // a Book object.
    @PostMapping
