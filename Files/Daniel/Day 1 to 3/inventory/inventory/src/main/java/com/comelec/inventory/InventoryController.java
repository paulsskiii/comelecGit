...
public class InventoryController {
    ...
    public Product addProduct(@RequestBody Product newProduct) {
        // @RequestBody takes the JSON payload and converts it into a 'newProduct' Java object
    ...
    public Product getProductById(@PathVariable Long id) {
        // @PathVariable extracts the {id} from the URL and assigns it to the Long id variable
