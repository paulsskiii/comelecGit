...
public class TravelController {
    ...
    private List<Destination> bucketList = Arrays.asList(
        new Destination(1, "Kyoto", "Japan", "Famous for its classical Buddhist temples, as well as gardens, imperial palaces, Shinto shrines and traditional wooden houses."),
        new Destination(2, "Reykjavik", "Iceland", "The coast of Iceland is home to the Blue Lagoon and the Northern Lights."),
