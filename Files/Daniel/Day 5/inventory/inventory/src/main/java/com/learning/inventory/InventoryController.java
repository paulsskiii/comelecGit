...
public class InventoryController {
    ...
    public String getInventory(Model model) {
        ...
        List<Product> myProducts = Arrays.asList(
            new Product("Gaming Laptop", 1200.00, 5, false),   // In stock
            new Product("Mechanical Keyboard", 150.00, 0, false), // Out of stock
            new Product("Wireless Mouse", 45.50, 50, false),     // Plenty of stock
            new Product("HD Monitor", 300.00, 1, true)          // Low stock
        );
